export default {
  ...
  healthSelection: {
    ...
    childVaccination: 'Child Vaccination',
    childVaccinationDesc: 'Track your child vaccination timeline and stay updated with upcoming doses.',
    exploreChildVaccination: 'Explore Child Vaccination',
    sakhiSetuForum: 'SakhiSetu Forum',
    sakhiSetuForumDesc: 'Ask questions, share experiences, and connect with the SakhiSetu community forum.',
    exploreSakhiSetuForum: 'Explore SakhiSetu Forum',
  ...
  community: {
    ...
    forumMenstrual: 'Menstrual Health',
    forumMaternal: 'Maternal Health',
    forumDisclaimer:
      'This forum is for informational and community support purposes only. It does not replace professional medical advice. Please consult a healthcare provider for medical concerns.',
    forumCreate: 'Create',
    forumCreateTitle: 'Create Post',
    forumChannel: 'Channel',
    forumTitleOptional: 'Title (optional)',
    ...
    forumEmptyTitle: 'No posts yet',
    forumEmptyBody: 'Be the first to ask a question or share an experience.',
    forumPost: 'Post',
    forumReplies: 'Replies',
    forumNoReplies: 'No replies yet. Be kind and supportive.',
    forumReplyPlaceholder: 'Write a reply...',
    forumInfoTitle: 'Forum info',
    forumEditReplyTitle: 'Edit reply',
    forumDeleteConfirmReply: 'Delete this reply? This cannot be undone.',
    forumDeleteConfirmPost: 'Delete this post? This cannot be undone.',
    forumSave: 'Save',
    forumBookmarkDone: 'Saved.',
    forumReport: 'Report',
    ...
    forumSaved: 'Saved',
    forumSavedTitle: 'Saved Posts',
    forumSavedEmptyTitle: 'No saved posts yet',
    forumSavedEmptyBody: 'Tap Save on any post to keep it here for later.',
  },
