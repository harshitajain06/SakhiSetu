...
export const prenatalCareData = [
  {
    ...
    sources: [NHM_MCP_CARD, UNICEF_PARENTING_FIRST_TRIMESTER, NHP_ANTENATAL_EARLY],
    tips: [
  ...
  },
  {
    ...
    sources: [MOHFW_MY_SAFE_MOTHERHOOD, UNICEF_PARENTING_FETAL_MATERNAL, NHP_MATERNAL_MILESTONES],
    tips: [
  ...
  },
  {
    ...
    sources: [NHM_OPERATIONAL_MATERNAL_HEALTH, UNICEF_PARENTING_PREPARING_BIRTH, NHP_FINAL_STAGES_LABOR],
    tips: [
  ...
  },
  {
    ...
    sources: [MOHFW_IFA_GUIDELINES, UNICEF_NUTRITION_SUPPLEMENTS_PREGNANCY, AMB_PREGNANT_WOMEN],
    tips: [
  ...
  },
  {
    ...
    sources: [PMSMA, NHP_ANTENATAL_CLINICAL, UNICEF_WHY_PRENATAL],
    tips: [
  ...
  },
  {
    ...
    sources: [NHM_MATERNAL_DANGER_SIGNS, UNICEF_PREGNANCY_DANGER_SIGNS, NHP_COMMON_DISCOMFORTS],
    tips: [
