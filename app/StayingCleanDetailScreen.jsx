...
export default function StayingCleanDetailScreen() {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{t('menstrual.stayingClean')}</Text>
      ...
      <View style={styles.imageContainer}>
        <ContentIllustration imageType={item.imageType} category="stayingClean" />
      </View>
      ...
      <SourcesSection sources={item.sources} accentColor="#2196F3" />
