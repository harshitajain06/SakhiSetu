  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{t('newbornCare.title')}</Text>
      ...
      {item.tips && item.tips.length > 0 && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionTitle}>{t('newbornCare.keyTips')}</Text>
          </View>
      ...
      {item.importantNote && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionTitle}>{t('newbornCare.importantNote')}</Text>
          </View>
      ...
      <SourcesSection sources={item.sources} accentColor="#9C27B0" />
